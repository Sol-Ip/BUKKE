...
public class Notice {
	...
	public String toString() {
		return "Notice [nFileNum=" + nFileNum + ", noticeNo=" + noticeNo + ", nFileName=" + nFileName + ", nFileSize="
				+ nFileSize + ", nFileType=" + nFileType + ", nFileDate=" + nFileDate + ", noticeStatus=" + noticeStatus
				+ ", nFilePath=" + nFilePath + ", nOriginalFilename=" + nOriginalFilename + ", nRenameFilename="
				+ nRenameFilename + ", noticeTitle=" + noticeTitle + ", noticeContents=" + noticeContents
