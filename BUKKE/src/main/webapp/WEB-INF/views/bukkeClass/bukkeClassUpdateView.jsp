		...
		<div class="container">
			<div class="row no-gutters slider-text align-items-center justify-content-center">
				<div class="col-md-9 ftco-animate text-center">
					...
					<p class="mr-2" style="color:#595959;">취미를 수정해주세요.</p>
				</div>
			</div>
		</div>
	</section>
					...
					<div class="row border col-md-12">
						...
						<div class="row col-md-12">
							<div class="col-md-8">
								...
								<input type="text" id="className" class="form-control" name="className" value="${bukkeClass.className }"
									autocomplete="off" placeholder="강좌명을 작성해주세요!" required maxlength="50" /><hr>
							</div>
							<div class="col-md-4">
								<label class="form-label" for="classPrice">강좌 금액</label> 
								<input type="text" id="classPrice" class="form-control" name="classPrice"  value="${bukkeClass.classPrice }"
						...
						<div class="row col-md-12" style="align:center;">
							...
							<div class="calendar">
									...
									<br> 
									<input type="date" value="${bukkeClass.classStartDate }" name="classStartDate" placeholder="시작일" required>
							</div>
							</div>
							<div class="col-md-4">
							<div class="calendar">
									...
									<br>
									<input type="date" value="${bukkeClass.classEndDate }" name="classEndDate" placeholder="종료일" required>
							</div>
							...
							<br>
								<input type="number" min="1" max="10" class="form-control" id="classCapacity" name="classCapacity" value="${bukkeClass.classCapacity }" placeholder="수강 인원은 1~10명입니다." required>
							</div>
						</div>
						...
						<hr>
							...
							<div class="startTime">
									...
									<br> 
									<input type="text" class="timepicker" name="classStartTime" value="${bukkeClass.classStartTime }" style="width:240px;" placeholder="시작 시간" required>
							</div>
							</div>
							<div class="col-md-4">
							<div class="endTime">
									...
									<br> 
									<input type="text" class="timepicker" name="classEndTime" value="${bukkeClass.classEndTime }" style="width:240px;" placeholder="종료 시간" required>
							</div>
							</div>
							</div>
						<hr>
						<label class="form-label" for="classAddr">클래스 주소</label>&nbsp;&nbsp;&nbsp;
							...
							<div class="col-md-12">
								<div id="aadr1-input" class="input-div">
		                            <input type="text" name="classAddr1" id="classAddr1" value="${bukkeClass.classAddr }" placeholder="기본주소" readonly>
		                            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							...
							<hr>
								...
								<textarea id="summernote" name="classInfo" class="summernote" required>${bukkeClass.classInfo }</textarea>
							<br>
							<hr>
							<c:if test = "${!empty bukkeClass.cOriginalFilename }">
								<input type="file" class="form-control" name="reloadFile" required>
								기존 파일 : ${bukkeClass.cOriginalFilename }
							</c:if>
							<br>
						</div>
						<br>
						...
						<div class="button-set text-center">
							 <input type="submit" value="수정" id="write-btn" class="btn btn-lg btn-primary" onclick="alert('수정 완료 되었습니다.')"> 
