...
<div id="gradient">
			<div class="container"> 
			  <!-- Example row of columns -->
						...
						<br>
						<br>
						<h1 align="center">아웃도어에 관심이 있으시군요!🌹</h1>
						<h2 align="center">어떤 장르를 좋아하세요?</h2>
						<br>
						<div align="center">
					
								 <c:url var="outdoor" value="giftListForAct.com">
										<c:param name="activityType" value="아웃도어"></c:param>
			                     		<c:param name="activityTypeDetails" value="등산 및 트래킹"></c:param>
			                  		</c:url>
										<h3>
											<div class="col-md-3 col-sm-3 col-xs-6"> <a href="${outdoor }" class="btn btn-sm animated-button thar-one" style="font-size:30px;font-family: 'NeoDunggeunmo';z-index: 100;">등산 및 트래킹</a> </div>
										</h3>
									<c:url var="outdoor2" value="giftListForAct.com">
										<c:param name="activityType" value="아웃도어"></c:param>
			                     		<c:param name="activityTypeDetails" value="낚시"></c:param>
			                  		</c:url>
										<h3>
											<div class="col-md-3 col-sm-3 col-xs-6"> <a href="${outdoor2 }" class="btn btn-sm animated-button thar-two" style="border:solid 2px red;font-size:30px;font-family: 'NeoDunggeunmo';z-index: 100;">낚시</a> </div>
										</h3>	
