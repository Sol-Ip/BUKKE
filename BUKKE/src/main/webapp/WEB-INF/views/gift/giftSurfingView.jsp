...
<div id="gradient">
			<div class="container"> 
			  <!-- Example row of columns -->
						...
						<br>
						<br>
						<h1 align="center">서핑에 관심이 있으시군요!🌹</h1>
						<h2 align="center">어떤 장르를 좋아하세요?</h2>
						<br>
						<div align="center">
					
								 <c:url var="surfing" value="giftListForAct.com">
										<c:param name="activityType" value="서핑"></c:param>
			                     		<c:param name="activityTypeDetails" value="당일치기"></c:param>
			                  		</c:url>
										<h3>
											<div class="col-md-3 col-sm-3 col-xs-6"> <a href="${surfing }" class="btn btn-sm animated-button thar-one" style="font-size:30px;font-family: 'NeoDunggeunmo';z-index: 100;">당일치기</a> </div>
										</h3>
									<c:url var="surfing2" value="giftListForAct.com">
										<c:param name="activityType" value="서핑"></c:param>
			                     		<c:param name="activityTypeDetails" value="1박2일"></c:param>
			                  		</c:url>
										<h3>
											<div class="col-md-3 col-sm-3 col-xs-6"> <a href="${surfing2 }" class="btn btn-sm animated-button thar-two" style="border:solid 2px red;font-size:30px;font-family: 'NeoDunggeunmo';z-index: 100;">1박2일</a> </div>
										</h3>	
									<c:url var="surfing3" value="giftListForAct.com">
										<c:param name="activityType" value="서핑"></c:param>
			                     		<c:param name="activityTypeDetails" value="강습 및 렌탈권"></c:param>
			                  		</c:url>
										<h3>
											<div class="col-md-3 col-sm-3 col-xs-6"> <a href="${surfing3 }" class="btn btn-sm animated-button thar-two" style="border:solid 2px red;font-size:30px;font-family: 'NeoDunggeunmo';z-index: 100;">강습 및 렌탈권</a> </div>
										</h3>
						</div>
