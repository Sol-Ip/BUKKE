...
<div id="gradient">
			<div class="container"> 
			  <!-- Example row of columns -->
						...
						<br>
						<br>
						<h1 align="center">수상레저에 관심이 있으시군요!🌹</h1>
						<h2 align="center">어떤 장르를 좋아하세요?</h2>
						<br>
						<div align="center">
					
								 <c:url var="water" value="giftListForAct.com">
										<c:param name="activityType" value="수상레저"></c:param>
			                     		<c:param name="activityTypeDetails" value="스노쿨링 및 다이빙"></c:param>
			                  		</c:url>
										<h3>
											<div class="col-md-3 col-sm-3 col-xs-6"> <a href="${water }" class="btn btn-sm animated-button thar-one" style="font-size:30px;font-family: 'NeoDunggeunmo';z-index: 100;">스노쿨링 및 다이빙</a> </div>
										</h3>
									<c:url var="water2" value="giftListForAct.com">
										<c:param name="activityType" value="수상레저"></c:param>
			                     		<c:param name="activityTypeDetails" value="낚시"></c:param>
			                  		</c:url>
										<h3>
											<div class="col-md-3 col-sm-3 col-xs-6"> <a href="${water2 }" class="btn btn-sm animated-button thar-two" style="border:solid 2px red;font-size:30px;font-family: 'NeoDunggeunmo';z-index: 100;">낚시</a> </div>
										</h3>	
