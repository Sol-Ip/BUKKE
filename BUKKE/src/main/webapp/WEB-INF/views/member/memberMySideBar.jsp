        ...
        <nav class="nav">
            <div>
                <div class="nav__brand">
                    ...
                    <a href="memberMyPage.com" class="nav__logo">BUKKE</a>
                </div>
                <div class="nav__list">
                    ...
                    <div href="#" class="nav__link collapse1">
                        ...
                        <ul class="collapse__menu">
                            <a href="scheduleTest.com" class="collapse__sublink">부캐 일정</a>
                            <a href="myReservationList.com" class="collapse__sublink">부캐 예약목록</a>
                    ...
                    <div href="#" class="nav__link collapse1">
                        ...
                        <ul class="collapse__menu">
                       		<a href="memberCAList.com" class="collapse__sublink">들었던 수업</a>
