	...
	<section class="ftco-section">
				...
				<div class="row justify-content-center">
					<div class="col-md-4 heading-section ftco-animate">
						<span class="subheading subheading-with-line"><small
							class="pr-2 bg-light">ACTIVITY LIST</small></span>
	 ...
	 <c:forEach items="${aList }" var="aList">
	        <c:url var="aDetail" value="activityDetail.com">
				<c:param name="activityNo" value="${aList.activityNo }"></c:param>
			</c:url>
  <div class="card">
    <div class="card__image-holder">
       <img class="card__image" style="width: 100%" src="resources/images/activityImageFiles/${aList.aRenameFilename}" alt="wave" /> 
    </div>
    <div class="card-title">
      <a href="${aDetail }" class="toggle-info btn">
        <span class="left"></span>
        <span class="right"></span>
      </a>
      <h2>
          <small>${aList.activityName }</small>
      </h2>
    </div>
    <div class="card-flap flap1">
      ...
      <div class="card-flap flap2">
        <div class="card-actions">
          <button onclick="location.href = '${aDetail}' " style="background-color: white; " id="btbt">Click</button>
        </div>
      </div>
    </div>
  </div>
    	...
    	<div class="row no-gutters mt-5">	
          <div class="col text-center">
            <div class="block-27">
              <!-- 이전 --> 
              <ul>
	            <c:url var="before" value="shopActivityList.com">
                ...
                <c:forEach var="p" begin="${shopPi.startPage }" end="${shopPi.endPage }">
	               <c:url var="pagination" value="shopActivityList.com">
	               ...
	               <c:if test="${p ne shopPi.currentPage }">
	                  <li ><a href="${shopPagination }">${p }</a></li>
	               </c:if>
            	</c:forEach>
            	<!-- 다음 -->
	            <c:url var="after" value="shopActivityList.com">
	               <c:param name="page" value="${shopPi.currentPage + 1 }"></c:param>
	            </c:url>
