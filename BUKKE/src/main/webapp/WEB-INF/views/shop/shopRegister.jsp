	...
	<div class="container">
        <form action="shopRegister.com" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="password" class="form-control" name="shopPw" placeholder="비밀번호를 입력해주세요" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="ceoName" placeholder="대표자명을 입력해주세요" required>
                <div class="invalid-check invalid-name">필수 정보입니다.</div>
            </div>
            <div class="form-group">
                <label for="shopName">업체명</label>
                <input type="text" class="form-control" name="shopName" placeholder="업체명을 입력해주세요" required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control postcodify_address" name="shopAddr1" readonly required>
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="shopPhone" placeholder="-를 제외한 전화번호를 입력해주세요" required>
                <div class="invalid-check invalid-phone">필수 정보입니다.</div>
            </div>
            <div class="form-group">
                <label for="shopEmail">이메일</label>
                <input type="text" class="form-control" name="shopEmail" placeholder="이메일을 입력해주세요" required>
